// Generated from fr/ensimag/deca/syntax/DecaParser.g4 by ANTLR 4.13.2
...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		INCLUDE__DIRECTIVE=1, OBRACE=2, CBRACE=3, OPARENT=4, CPARENT=5, SEMI=6, 
		COMMA=7, DOT=8, PRINTLNX=9, PRINTLN=10, PRINTX=11, PRINT=12, CLASS=13, 
		EXTENDS=14, PROTECTED=15, NEW=16, THIS=17, NULL=18, INSTANCEOF=19, ASM=20, 
		COMMENT=21, MULTI_COMMENT=22, STRING=23, MULTI_LINE_STRING=24, FLOAT=25, 
		INT=26, READINT=27, READFLOAT=28, PLUS=29, MINUS=30, TIMES=31, SLASH=32, 
		PERCENT=33, LEQ=34, GEQ=35, GT=36, LT=37, NEQ=38, EQEQ=39, EQUALS=40, 
		EXCLAM=41, TRUE=42, FALSE=43, AND=44, OR=45, WHILE=46, IF=47, ELSE=48, 
		RETURN=49, IDENT=50, WS=51;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, "'{'", "'}'", "'('", "')'", "';'", "','", "'.'", "'printlnx'", 
			"'println'", "'printx'", "'print'", "'class'", "'extends'", "'protected'", 
			"'new'", "'this'", "'null'", "'instanceof'", "'asm'", null, null, null, 
			null, null, null, "'readInt'", "'readFloat'", "'+'", "'-'", "'*'", "'/'", 
			"'%'", "'<='", "'>='", "'>'", "'<'", "'!='", "'=='", "'='", "'!'", "'true'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "INCLUDE__DIRECTIVE", "OBRACE", "CBRACE", "OPARENT", "CPARENT", 
			"SEMI", "COMMA", "DOT", "PRINTLNX", "PRINTLN", "PRINTX", "PRINT", "CLASS", 
			"EXTENDS", "PROTECTED", "NEW", "THIS", "NULL", "INSTANCEOF", "ASM", "COMMENT", 
			"MULTI_COMMENT", "STRING", "MULTI_LINE_STRING", "FLOAT", "INT", "READINT", 
			"READFLOAT", "PLUS", "MINUS", "TIMES", "SLASH", "PERCENT", "LEQ", "GEQ", 
			"GT", "LT", "NEQ", "EQEQ", "EQUALS", "EXCLAM", "TRUE", "FALSE", "AND", 
			"OR", "WHILE", "IF", "ELSE", "RETURN", "IDENT", "WS"
		};
	}
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1915350841499216L) != 0)) {
				{
				{
				setState(122);
	...
	public final InstContext inst() throws RecognitionException {
		...
		try {
			...
			case SEMI:
				...
				// rien se passe
				            Location loc = new Location((((InstContext)_localctx).SEMI!=null?((InstContext)_localctx).SEMI.getLine():0), ((InstContext)_localctx).SEMI.getCharPositionInLine()+1, getInputStream().getSourceName());
				            ((InstContext)_localctx).tree =  new NoOperation(loc);
	...
	public final If_then_elseContext if_then_else() throws RecognitionException {
		...
		try {
			...
			match(CBRACE);
			            ...
			            // ((If_then_elseContext)_localctx).tree =  new IfThenElse(((If_then_elseContext)_localctx).condition.tree,((If_then_elseContext)_localctx).li_if.tree, elseDeIf);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(CBRACE);
					            ...
					            elseIfConditions.add(((If_then_elseContext)_localctx).elsif_cond.tree);
					            IfImbriquefI.add(((If_then_elseContext)_localctx).elsif_li.tree);
			...
			if (_la==ELSE) {
				...
				match(CBRACE);
				            ...
				            if(IfImbriquefI.isEmpty()){
				                    ((If_then_elseContext)_localctx).tree =  new IfThenElse(((If_then_elseContext)_localctx).condition.tree, ((If_then_elseContext)_localctx).li_if.tree, ((If_then_elseContext)_localctx).li_else.tree);
				                    //
				                    setLocation(_localctx.tree,((If_then_elseContext)_localctx).if1);
				                    //
				            }
				                ...
				                IfThenElse currElse = new IfThenElse(elseIfConditions.get(elseIfConditions.size()-1),
				                                                        IfImbriquefI.get(IfImbriquefI.size()-1),((If_then_elseContext)_localctx).li_else.tree);
				                //
				                setLocation(currElse,((If_then_elseContext)_localctx).if1);
				                //
				                ...
				                ((If_then_elseContext)_localctx).tree =  new IfThenElse(((If_then_elseContext)_localctx).condition.tree, ((If_then_elseContext)_localctx).li_if.tree, wrapperIfInit);
				                //
				                setLocation(_localctx.tree,((If_then_elseContext)_localctx).if1);
				                // 
				            }
			        ...
			        if (_localctx.tree == null){
			            ...
			            if(IfImbriquefI.isEmpty()){
			                    ((If_then_elseContext)_localctx).tree =  new IfThenElse(((If_then_elseContext)_localctx).condition.tree, ((If_then_elseContext)_localctx).li_if.tree, elseVide);
			                    setLocation(_localctx.tree,((If_then_elseContext)_localctx).if1);
			            }
			            else{
			                IfThenElse currElse = new IfThenElse(elseIfConditions.get(elseIfConditions.size()-1),
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1141294655537168L) != 0)) {
				{
				setState(216);
		...
		try {
			...
			case EQUALS:
				...
				((Assign_exprContext)_localctx).e2 = assign_expr();
				            ...
				            setLocation(_localctx.tree, ((Assign_exprContext)_localctx).EQUALS);//faire monter des valeurs
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(383);
					((Select_exprContext)_localctx).op = match(DOT);
					setState(384);
					...
					case 1:
						...
						match(CPARENT);
						                      ...
						                      setLocation(_localctx.tree, ((Select_exprContext)_localctx).op);   
		...
		try {
			...
			case INT:
				...
				((LiteralContext)_localctx).INT = match(INT);
				        ...
				        try {
				            ...
				            throw new RuntimeException((((LiteralContext)_localctx).INT!=null?((LiteralContext)_localctx).INT.getLine():0) + ":" + (((LiteralContext)_localctx).INT!=null?((LiteralContext)_localctx).INT.getCharPositionInLine():0) + 
				                ": L'entier '" + (((LiteralContext)_localctx).INT!=null?((LiteralContext)_localctx).INT.getText():null) + "' est trop grand pour un int 32 bits.");
				        }
			...
			case FLOAT:
				...
				((LiteralContext)_localctx).fd = match(FLOAT);
				        ...
				        try {
				            float val = Float.parseFloat((((LiteralContext)_localctx).fd!=null?((LiteralContext)_localctx).fd.getText():null));
				            if (Float.isInfinite(val)) { throw new NumberFormatException(); }
				            ((LiteralContext)_localctx).tree =  new FloatLiteral(val);
				        } catch (NumberFormatException e) {
				            throw new RuntimeException((((LiteralContext)_localctx).fd!=null?((LiteralContext)_localctx).fd.getLine():0) + ":" + (((LiteralContext)_localctx).fd!=null?((LiteralContext)_localctx).fd.getCharPositionInLine():0) + 
				                ": Le flottant '" + (((LiteralContext)_localctx).fd!=null?((LiteralContext)_localctx).fd.getText():null) + "' est hors des limites.");
				        }
			...
			case STRING:
				...
				((LiteralContext)_localctx).STRING = match(STRING);
				        ...
				        ((LiteralContext)_localctx).tree =  new StringLiteral(text);
	...
	public final IdentContext ident() throws RecognitionException {
		...
		try {
			...
			((IdentContext)_localctx).IDENT = match(IDENT);
			        ...
			        assert(((IdentContext)_localctx).IDENT != null);
			        Symbol sym = getDecacCompiler().createSymbol((((IdentContext)_localctx).IDENT!=null?((IdentContext)_localctx).IDENT.getText():null));
			        ((IdentContext)_localctx).tree =  new Identifier(sym);
	...
	public final Class_declContext class_decl() throws RecognitionException {
		...
		try {
			...
			{
			setState(469);
			((Class_declContext)_localctx).cn = match(CLASS);
			setState(470);
			...
			match(OBRACE);
			setState(473);
			class_body(fields,methods);
			setState(474);
			match(CBRACE);

			        ((Class_declContext)_localctx).tree =  new DeclClass(((Class_declContext)_localctx).name.tree, ((Class_declContext)_localctx).superclass.tree, fields, methods);
			        setLocation(_localctx.tree, ((Class_declContext)_localctx).cn);
			        if (((Class_declContext)_localctx).superclass.tree.getLocation() == null) {
			             setLocation(((Class_declContext)_localctx).superclass.tree, ((Class_declContext)_localctx).cn);
			        }
		...
		try {
			...
			case EXTENDS:
				...
				((Class_extensionContext)_localctx).ident = ident();
				        ...
				        setLocation(((Class_extensionContext)_localctx).ident.tree,((Class_extensionContext)_localctx).EXTENDS);
	...
	public static class Class_bodyContext extends ParserRuleContext {
		...
		public Class_bodyContext(ParserRuleContext parent, int invokingState, ListDeclField fields, ListDeclMethod methods) {
			super(parent, invokingState);
			this.fields = fields;
	...
	public final Class_bodyContext class_body(ListDeclField fields,ListDeclMethod methods) throws RecognitionException {
		Class_bodyContext _localctx = new Class_bodyContext(_ctx, getState(), fields, methods);
	...
	public final Decl_field_setContext decl_field_set(ListDeclField fields) throws RecognitionException {
		...
		try {
			...
			setState(495);
			list_decl_field(((Decl_field_setContext)_localctx).v.tree,((Decl_field_setContext)_localctx).t.tree,fields);
			setState(496);
			match(SEMI);
			}
		}
	...
	public static class List_decl_fieldContext extends ParserRuleContext {
		...
		public List_decl_fieldContext(ParserRuleContext parent, int invokingState, Visibility v, AbstractIdentifier t, ListDeclField fields) {
			super(parent, invokingState);
			this.v = v;
			this.t = t;
			this.fields = fields;
	...
	public final List_decl_fieldContext list_decl_field(Visibility v,AbstractIdentifier t,ListDeclField fields) throws RecognitionException {
		List_decl_fieldContext _localctx = new List_decl_fieldContext(_ctx, getState(), v, t, fields);
		...
		try {
			...
			{
			setState(503);
			((List_decl_fieldContext)_localctx).dv1 = decl_field(v,t,fields);
			setState(508);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				match(COMMA);
				setState(505);
				((List_decl_fieldContext)_localctx).dv2 = decl_field(v,t,fields);
				}
				}
				setState(510);
				_errHandler.sync(this);
	...
	public static class Decl_fieldContext extends ParserRuleContext {
		...
		public Decl_fieldContext(ParserRuleContext parent, int invokingState, Visibility v, AbstractIdentifier t, ListDeclField fields) {
			super(parent, invokingState);
			this.v = v;
			this.t = t;
			this.fields = fields;
	...
	public final Decl_fieldContext decl_field(Visibility v,AbstractIdentifier t,ListDeclField fields) throws RecognitionException {
		Decl_fieldContext _localctx = new Decl_fieldContext(_ctx, getState(), v, t, fields);
		...
		try {
			...
			if (_la==EQUALS) {
				...
				((Decl_fieldContext)_localctx).e = expr();
				          ...
				          setLocation(initialization, ((Decl_fieldContext)_localctx).EQUALS); // <--- AJOUTE CECI !
			        ...
			        if (initialization.getLocation() == null) {
			             setLocation(initialization, (((Decl_fieldContext)_localctx).i!=null?(((Decl_fieldContext)_localctx).i.start):null));
			        }
			        DeclField field = new DeclField(v,t,((Decl_fieldContext)_localctx).i.tree,initialization);
		...
		try {
			...
			case OBRACE:
				...
				((Decl_methodContext)_localctx).block = block();
				        ...
				        AbstractMethodBody body = new MethodBody(((Decl_methodContext)_localctx).block.decls, ((Decl_methodContext)_localctx).block.insts);
				        setLocation(body, (((Decl_methodContext)_localctx).block!=null?(((Decl_methodContext)_localctx).block.start):null));
				        ((Decl_methodContext)_localctx).tree =  new DeclMethod(((Decl_methodContext)_localctx).type.tree,((Decl_methodContext)_localctx).id.tree,((Decl_methodContext)_localctx).params.tree,body);
			...
			case ASM:
				...
				match(SEMI);
				        ...
				        String asmName = ((Decl_methodContext)_localctx).code.text;
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			((ParamContext)_localctx).ident = ident();
			        ...
			        setLocation(_localctx.tree, (((ParamContext)_localctx).ident!=null?(((ParamContext)_localctx).ident.start):null));
